  ...
  return (
    <div className="min-h-screen bg-slate-950">
      ...
      <div className="border-b border-slate-800 bg-amber-950/20 px-4 py-2 text-center text-xs text-amber-400">
        Data is sourced from January 2017 till Roland Garros 2026. Matches before or after that date aren't reflected in ratings or predictions. H2H may not be fully accurate
      </div>
